...
git add .
git commit 
git push origin main  # Εφόσον εργάζεσαι στον κλάδο main
git push origin main 
git remote -v
git remote add other https://gitlab.com/username/repo.git
git remote add other https://github.com/progintro/hw1-askourtsidi
git remote add https://github.com/progintro/hw1-askourtsidi
git remote -v
git push other main  # Στέλνει τις αλλαγές στον απομακρυσμένο διακομιστή "other" στον κλάδο "main"
git push progintro/hw1-askourtsidi main
git push https://github.com/progintro/hw1-askourtsidi main
git push https://github.com/progintro/hw1-askourtsidi master
gcc -O3 -Wall -Wextra -pedantic -o rsa rsa.c
gcc -O3 -Wall -Wextra -pedantic -o rsa rsa.c -lm
gcc -O3 -Wall -Wextra -pedantic -o rsa rsa.c -lm
git push https://github.com/progintro/hw1-askourtsidi master
./gcd 68719476736 84767329979727872
